# OpenAI-compatible API 网关是什么？

> OpenAI-compatible API gateway guide
...
Users searching for this topic usually want practical answers about: OpenAI-compatible API, API gateway, OpenAI SDK compatible. They may already have real API call demand and need a maintainable way to connect multiple models without rewriting every integration.
