# Node.js 如何接入 Claude、GPT、Gemini？

> Node.js OpenAI-compatible multi-model API example
...
Users searching for this topic usually want practical answers about: Node.js Claude API, Node.js OpenAI-compatible API. They may already have real API call demand and need a maintainable way to connect multiple models without rewriting every integration.
